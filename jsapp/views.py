...
class AnswerList(ListView):
    ...
    def get_context_data(self,*args,**kwargs,):
        ...
        ctx['title'] = VenueModel.objects.filter(venueid=self.kwargs['num']).all()
        return  ctx
...
class AnswerCreate(CreateView):
    ...
    fields = ('eventtitle','venue','venueid','matinee','evening','ticket1','sheet1','floor1','block1','number1','ticket2','sheet2','floor2','block2','number2',)
    def get_context_data(self,*args,**kwargs,):
        ctx = super().get_context_data(**kwargs)
